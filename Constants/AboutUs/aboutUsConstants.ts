...
const teamMembers: TeamMember[] = [
  {
    ...
    descriptionParagraphs: [
      ...
      "As the visionary founder and CEO of Premier Specialty Infusion (PSI), Ashar transformed the specialty infusion services landscape nationwide. Previously, co-founded and led Envoy Innovations, empowering healthcare providers with cutting-edge technology to analyze treatment outcomes. At Walgreens/OptionCare, led the Immunoglobulin Program to national prominence following the acquisition of Rx Solutions, where Ashar served as CEO/President and guided it into becoming the fastest-growing specialty injectable provider. Early leadership roles at Crescent Healthcare and Apria Healthcare provided a strong foundation in operational and strategic expertise.",
  ...
  },
  {
    ...
    description:
      "Courtney spearheads Medmonks business development initiatives, meticulously tracking industry trends and collaborating with biotechnology and pharmaceutical manufacturers...",
    descriptionParagraphs: [
  ...
  },
  {
    ...
    description:
      "Mary Jercich brings over a decade of specialized experience in the pharmacy realm, making her an indispensable asset to Medmonks mission. Since starting with...",
    descriptionParagraphs: [
...
"6. Launched complete automated medical benefit co-pay solution 2017",
"7. Launched fully automated PAP solution in 2018",
"8. Launched a hub service solution for several brands in 2018",
"9. Medmonk’s technology achieve COX II Certification in 2022",
"10. Assisted 10 million patients since its inception in 2021",
"11. Launched Proprietary automated BI & PA solution 2023",
"12. Launched unique AI capabilities 2024",
];
