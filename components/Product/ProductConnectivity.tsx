...
const ProductConnectivity = () => {
  return (
    <div className="grid items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-col-2 gap-4 lg:gap-8">
      <section className="pt-2 xl:pt-6 pb-8 xl:pb-20 flex flex-col overflow-hidden animate__animated animate__fadeIn animate__slow wow">
          ...
          <div className="text-center max-w-7xl max-w- mx-auto px-4">
            <div className="animate__ animate__fadeInDown animate__slow wow animated">
              <Image
                ...
                decoding="async"
                data-nimg="1"
                className=" max-w-sm w-full mx-auto md:mb-5 mb-0"
                sizes="100vw"
                src={Connectivity}
              />
            </div>
...
export default ProductConnectivity;
