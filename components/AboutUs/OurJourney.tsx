...
const OurJourney = () =>
    {
        return (<section className="pb-16 xl:pb-20 overflow-hidden">
            <div className="container mx-auto">
              ...
              <div className="mt-4 max-w-7xl mx-auto pt-4 xl:pt-8 px-6 lg:px-0">
                <ul className="block md:grid grid-cols-12 items-end align-middle text-center gap-3 journy-step text-sm text-lightGray">
