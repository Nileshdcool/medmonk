              ...
              <nav className="bg-headerBG dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div 
                      className="md:relative absolute items-center justify-between w-full md:flex md:w-auto  bg-white md:bg-transparent left-0 right-0 mt-9 md:mt-0" id="navbar-sticky">
