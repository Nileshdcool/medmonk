            ...
            <div className="pt-6 max-w-7xl mx-auto">
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <div className="card-box bg-white rounded-md p-6">
                    ...
                    <p className="text-lightGray my-3">Bryan Li, Chief Technology Officer at Medmonk, brings a wealth of experience from leading technology companies to his role, where he spearheads Medmonks technology initiatives...</p>
                    <Link href="" className="text-darkBlue font-bold">READ MORE</Link>
                  </div>
                  <div className="card-box bg-white rounded-md p-6">
                    <Image
